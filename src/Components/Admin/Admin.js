...
const Admin = () => {
    ...
    return (
        <div className='mt-md-4 mt-0'>
            ...
            <Link  className=' mt-2 text-white' style={{marginRight:'35px'}} onClick={() =>setAdminAction(false)}><FontAwesomeIcon icon={faPlus} className='text-dark mr-1'></FontAwesomeIcon> Add Books</Link>
